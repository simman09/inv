...
{
    public abstract class InventoryManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InventoryManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InventoryManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InventoryManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InventoryManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InventoryManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InventoryManagementDbContext, Task<T>> func)
        {
            T result;
